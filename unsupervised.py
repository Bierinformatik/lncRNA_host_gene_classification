...
if __name__=="__main__":
	parser = argparse.ArgumentParser(description="performs unsupervised training to cluster the three classes: NoHG, SNHG, MIRHG")
	...
	clusters.preprocess(features_combined,args)
